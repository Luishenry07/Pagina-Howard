// _seed_paquetes.js — Script para cargar los paquetes en Firestore
//
// INSTRUCCIONES:
// 1. Ve a https://luishenry07.github.io/Pagina-Howard/jcdetalles_landing.html
// 2. Inicia sesión como admin (botón Admin, esquina inferior derecha)
// 3. Abre la consola del navegador (F12 → pestaña "Console")
// 4. Pega TODO el contenido de este archivo y presiona Enter
// 5. Deberías ver: "✅ 14 paquetes importados correctamente."
//
// NOTA: Los precios están en 0 intencionalmente — el sitio no los muestra al público.

(async () => {
  if (!window.db) {
    console.error('❌ Firebase db no encontrado. ¿Estás en la página correcta y logueado?');
    return;
  }
  if (!window.firebase || !firebase.auth().currentUser) {
    console.error('❌ No estás autenticado. Inicia sesión como admin primero.');
    return;
  }
  ...
  const lista = [
    ...
    },
    {
      ...
      descripcion:
        ...
        'Decoración de iglesia: sillas de altar, 2 pedestales con arreglos grandes, arreglo floral del altar, botones para bancas. ' +
        '10 centros de mesa naturales con pedestal dorado. ' +
        'Mesa de recepción con buzón de cristales, trípode y pedestal floral. ' +
        'Mesa de dulce: arco/mamparas floral artificial, juego de mesas, bases y cristalería fina. ' +
        'Ramo de novia, botonier del novio y copas personalizadas para novios.'
    },
    {
      ...
      descripcion:
        ...
        'Candy bar: dulce de 4 niveles, 6 docenas de postres, arco/mamparas floral, bases y cristalería fina, iluminación. ' +
        ...
        'Murga y hora loca. Incluye montaje, desmontaje y acarreo.'
    },
...

    {
      ...
      descripcion:
        ...
        'Trono con Candy Bar: sofá blanco imperial, fondo de banner personalizado o telas, mamparas con tela y lámparas colgantes, arreglos de flores artificiales, número 15 LED y tuberías LED, 2 imágenes de la temática, bases y cristalería fina, candelabros dorados, iluminación, alfombra y luces robóticas. ' +
    ...
    },
    {
      ...
      descripcion:
        ...
        'Candy bar: mesa dorada grande, 2 mesas rectangulares rotuladas de la temática, bases y cristalería fina, candelabros, 4 esculturas de la temática, 2 mamparas con imagen de la quinceañera, arco con nombre, 4 arreglos florales grandes, iluminación. ' +
...

    {
      ...
      descripcion:
        ...
        'Murga y vestido de carnaval. Incluye montaje, desmontaje y acarreo.'
    },
    {
...

    {
      ...
      descripcion:
        ...
        'Candy bar premium: 4 docenas de postres, 4 docenas de golosinas, 10 docenas de souvenirs personalizados, mesa principal y mesas auxiliares, cristalería fina, candelabros, mamparas personalizadas, arco decorado, arreglos florales e iluminación. ' +
        'Mesa de bienvenida: arco de entrada, mesa de recepción decorada, arreglos florales, mamparas iluminadas y letrero LED PROM 2026. ' +
    ...
    },
    {
      ...
      descripcion:
        ...
        'Candy bar premium: 6 docenas de postres, 6 docenas de golosinas, 10 docenas de souvenirs, mesa principal dorada y mesas auxiliares, cristalería fina, esculturas temáticas gigantes, mamparas personalizadas, arco y arreglos florales, iluminación. ' +
        'Mesa de bienvenida con letrero de nombres de estudiantes por mesa, arreglos florales, mamparas iluminadas y letrero LED PROM 2026. ' +
        ...
        'Discoteca profesional: DJ, booth de DJ, sistema de sonido completo, 12 luces, truss, micrófono inalámbrico y 2 pantallas. ' +
    ...
    },
    {
      ...
      descripcion:
        ...
        'Decoración de tarima: fondo personalizado según temática, estructura truss con letrero e iluminación automatizada, 4 esculturas gigantes de la temática, rótulo de piso o pista iluminada, iluminación arquitectónica y luces robóticas profesionales. ' +
        'Candy bar premium: 6 docenas de postres, 6 docenas de golosinas, 10 docenas de souvenirs, mesa dorada grande y mesas auxiliares, cristalería fina, esculturas gigantes de la temática, mamparas personalizadas, arco decorado, arreglos florales e iluminación ambiental. ' +
  ...
  try {
    await db.doc('config/paquetes').set({ lista });
    console.log('✅ ' + lista.length + ' paquetes importados correctamente.');
    lista.forEach((p, i) => console.log('  ' + (i + 1) + '. [' + p.servicio + '] ' + p.nombre));
  } catch (e) {
